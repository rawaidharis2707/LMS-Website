...
function voidTransaction(id) {
    if (!confirm('Are you sure you want to void this transaction? This will mark it as void and cannot be undone.')) return;
    ...
    if (transaction) {
        ...
        transaction.voidReason = 'User voided transaction';
