            ...
            <div class="row g-4 mb-4">
                <div class="col-md-3">
                    <div class="stat-widget">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <p class="text-muted mb-1 text-uppercase small">Total Revenue</p>
                                <h3 class="fw-bold mb-0 text-success" id="dashRevenue">${{ number_format($stats['totalRevenue']) }}</h3>
                            </div>
                ...
                <div class="col-md-3">
                    <div class="stat-widget">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <p class="text-muted mb-1 text-uppercase small">Estimated Expenses</p>
                                <h3 class="fw-bold mb-0 text-danger" id="dashExpenses">${{ number_format($stats['totalExpenses']) }}</h3>
                            </div>
                    ...
                    <div class="stat-widget">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h3 class="fw-bold mb-0 text-primary" id="dashProfit">${{ number_format($stats['totalRevenue'] - $stats['totalExpenses']) }}</h3>
                            </div>
                ...
                <div class="col-md-3">
                    <div class="stat-widget">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <p class="text-muted mb-1 text-uppercase small">Total Users</p>
                                <h3 class="fw-bold mb-0 text-dark" id="dashUsers">{{ $stats['totalUsers'] }}</h3>
                            </div>
    ...
    <script>
        ...
        async function downloadUserReport() {
            try {
                ...
                users.forEach(u => {
                    csv += `${u.id},${u.name},${u.email},${u.role},${u.created_at || 'N/A'}\n`;
                });
        ...
        async function loadDashboardActivity() {
            ...
            tbody.innerHTML = '<tr><td colspan="4" class="text-center py-3"><div class="spinner-border spinner-border-sm text-primary"></div></td></tr>';
            ...
            try {
                ...
                logs.slice(0, 5).forEach(log => {
                    ...
                    tr.innerHTML = `
                        <td class="small text-muted">${new Date(log.created_at).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</td>
                ...
                tbody.innerHTML = '<tr><td colspan="4" class="text-center text-danger p-3">Error loading activity</td></tr>';
            }
        }
    </script>
</body>
