...
<head>
    ...
    <title>Funds Management - Super Admin Portal</title>
...
<body class="dashboard-body">
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-menu">
            <ul class="list-unstyled">
                ...
                <li class="sidebar-menu-item"><a href="{{ url('superadmin/finance') }}" class="sidebar-link active"><i
    ...
    <main class="main-content">
        <nav class="top-navbar">
            <div class="d-flex align-items-center">
                ...
                <h1 class="page-title mb-0">Funds Management</h1>
            </div>
            <div class="user-menu">
            ...
            <ul class="nav nav-tabs mb-4" id="financeTabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="dashboard-tab" data-bs-toggle="tab" data-bs-target="#dashboard"
                        type="button" role="tab"><i class="fas fa-tachometer-alt me-2"></i>Dashboard</button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="expenses-tab" data-bs-toggle="tab" data-bs-target="#expenses"
                        type="button" role="tab"><i class="fas fa-receipt me-2"></i>Expenses</button>
                </li>

                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="reports-tab" data-bs-toggle="tab" data-bs-target="#reports"
                        type="button" role="tab"><i class="fas fa-print me-2"></i>Reports</button>
                </li>
            </ul>
            ...
            <div class="tab-content" id="financeTabsContent">
                ...
                <div class="tab-pane fade show active" id="dashboard" role="tabpanel">
                    ...
                    <div class="row g-4 mb-4">
                            ...
                            <div class="stat-widget widget-success text-white">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        ...
                                        <h3 class="fw-bold mb-0" id="kpiRevenue">$0</h3>
                                    </div>
                        ...
                        <div class="col-md-3">
                            <div class="stat-widget widget-danger text-white">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h6 class="opacity-75 mb-1">Total Expenses</h6>
                                        <h3 class="fw-bold mb-0" id="kpiExpenses">$0</h3>
                                    </div>
                                    <div class="stat-widget-icon bg-white bg-opacity-25"><i
                        ...
                        <div class="col-md-3">
                            <div class="stat-widget widget-info text-white">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h6 class="opacity-75 mb-1">Net Profit</h6>
                                        <h3 class="fw-bold mb-0" id="kpiProfit">$0</h3>
                                    </div>
                                    <div class="stat-widget-icon bg-white bg-opacity-25"><i
                        ...
                        <div class="col-md-3">
                            <div class="stat-widget widget-warning text-white">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <h6 class="opacity-75 mb-1">Pending Fees</h6>
                                        <h3 class="fw-bold mb-0" id="kpiPending">$1,250</h3>
                                    </div>
                                    <div class="stat-widget-icon bg-white bg-opacity-25"><i class="fas fa-clock"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-8">
                            <div class="card border-0 shadow-sm h-100">
                                <div class="card-header bg-white border-0 py-3">
                                    <h5 class="mb-0 fw-bold">Revenue vs Expenses</h5>
                                </div>
                                <div class="card-body">
                    ...
                    <div class="card border-0 shadow-sm">
                        <div
                            ...
                            <div class="d-flex gap-2">
                                <button class="btn btn-outline-success" onclick="exportFinanceData()">
                ...
                <div class="tab-pane fade" id="reports" role="tabpanel">
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-header bg-white border-0 py-3">
                            <h5 class="mb-0 fw-bold"><i class="fas fa-chart-line text-primary me-2"></i> Financial
                                Report Generator</h5>
                        </div>
                        <div class="card-body">
                            <form id="reportForm" class="row g-3">
                                <div class="col-md-3">
                                    ...
                                    <select class="form-select" id="reportType" onchange="toggleReportDates()">
                                ...
                                <div class="col-md-3 report-date d-none" id="dateExactBox">
                                    <label class="form-label">Select Date</label>
                                    <input type="date" class="form-control" id="reportDate">
                                </div>
                                <div class="col-md-3 report-date" id="dateMonthBox">
                                    <label class="form-label">Select Month</label>
                                    <input type="month" class="form-control" id="reportMonth">
                                </div>
                                <div class="col-md-3 report-date d-none" id="dateYearBox">
                                ...
                                <div class="col-md-4 report-date d-none" id="dateCustomBox">
                                ...
                                <div class="col-md-2 d-flex align-items-end">
                                    <button type="button" class="btn btn-primary w-100" onclick="generateReport()"><i
                    ...
                    <div id="reportResult" class="d-none">
                        <div class="card border-0 shadow-sm">
                            <div
                                class="card-header bg-white border-0 py-3 d-flex justify-content-between align-items-center">
                                <h5 class="mb-0 fw-bold">Report Summary</h5>
                                <div>
                                    <button class="btn btn-outline-danger btn-sm me-2" onclick="printReport()"><i
                                            class="fas fa-file-pdf me-2"></i> Print PDF</button>
                                    <button class="btn btn-outline-success btn-sm" onclick="exportReportCSV()"><i
                                ...
                                <div class="row text-center mb-4">
                                    <div class="col-md-3">
                                        <div class="p-3 bg-light rounded">
                                            ...
                                            <h4 class="fw-bold text-success" id="repIncome">$0</h4>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="p-3 bg-light rounded">
                                            <h6 class="text-muted">Total Expense</h6>
                                            <h4 class="fw-bold text-danger" id="repExpense">$0</h4>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="p-3 bg-light rounded">
                                            <h6 class="text-muted">Net Profit</h6>
                                            <h4 class="fw-bold text-primary" id="repProfit">$0</h4>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="p-3 bg-light rounded">
                                            <h6 class="text-muted">Transactions</h6>
                                            <h4 class="fw-bold" id="repCount">0</h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="table-responsive">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-success text-white">
                    <h5 class="modal-title">Add Income (Credit)</h5>
                ...
                <div class="modal-body">
                    <form id="incomeForm">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" name="date" required id="incomeDate">
                        </div>
                        <div class="mb-3">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-danger text-white">
                    <h5 class="modal-title">Add Expense (Debit)</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                </div>
                <div class="modal-body">
                    <form id="expenseForm">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Date</label>
                            <input type="date" class="form-control" name="date" required id="expenseDate">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Description</label>
                            <textarea class="form-control" name="description" rows="2" required></textarea>
    ...
    <script src="{{ asset('assets/js/finance-functions.js') }}"></script>
    <script>
