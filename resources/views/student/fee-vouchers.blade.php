...
<body class="dashboard-body">
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-menu">
            <ul class="list-unstyled">
                ...
                <li class="sidebar-menu-item"><a href="fee-vouchers.html" class="sidebar-link active"><i
    ...
    <script>
        ...
        function downloadVoucher(voucherId) {
            ...
            window.open('print-voucher.html?' + params.toString(), '_blank', 'width=900,height=1000');
        }
