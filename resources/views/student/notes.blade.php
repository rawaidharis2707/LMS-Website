...
<head>
    ...
    <title>Notes & PDFs - Student Portal</title>
...
<body class="dashboard-body">
    ...
    <main class="main-content">
        <nav class="top-navbar">
            <div class="d-flex align-items-center">
                ...
                <h1 class="page-title mb-0">Notes & PDFs</h1>
            </div>
            <div class="user-menu">
        ...
        <div class="dashboard-content">
            <div class="card-modern animate-fade-in mb-4">
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-2">
                            <button class="btn btn-primary w-100" onclick="filterNotes()">
            ...
            <div class="row g-4" id="notesContainer"></div>
        </div>
    </main>
    ...
    <script>
        ...
        function loadNotes() {
            ...
            const searchInput = document.getElementById('searchNotes').value.toLowerCase();
            ...
            if (filteredNotes.length === 0) {
                container.innerHTML = '<div class="col-12 text-center text-muted py-5"><i class="fas fa-file-alt fa-3x mb-3"></i><p>No notes found matching your criteria.</p></div>';
                return;
            }

            let html = '';
            filteredNotes.forEach(note => {
                const color = getFileColor(note.fileType);
                        ...
                        <div class="card-modern animate-fade-in h-100 hover-lift">
                            <div class="card-body">
                                <div class="d-flex align-items-start mb-3">
                                    <div class="bg-${color} bg-opacity-10 text-${color} rounded p-3 me-3">
                                        <i class="fas fa-file-${icon} fa-2x"></i>
                                    </div>
                                ...
                                <div class="mb-3">
                                    <small class="text-muted d-block mb-1">
                                        <i class="fas fa-user me-2"></i> ${note.uploadedBy}
                                    </small>
                                    <small class="text-muted d-block mb-1">
                                        <i class="fas fa-calendar me-2"></i> ${formatDate(note.uploadDate)}
                                    </small>
                                </div>
                                <div class="d-grid gap-2">
                                    <button class="btn btn-primary btn-sm" onclick="downloadNote('${note.title}')">
                                        <i class="fas fa-download me-2"></i> Download
                                    </button>
                                    <button class="btn btn-outline-primary btn-sm" onclick="viewNote('${note.title}')">
        ...
        document.getElementById('searchNotes').addEventListener('keyup', loadNotes);
