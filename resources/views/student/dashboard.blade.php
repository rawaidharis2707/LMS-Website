...
<body class="dashboard-body">
            ...
            <div class="row g-4 mb-4">
                <div class="col-md-6 col-lg-3 animate-fade-in" style="animation-delay: 0.1s;">
                    <div class="stat-widget-modern lift">
                        ...
                        <h2 class="fw-bold mb-2"
                            style="font-family: 'Bungee', sans-serif; color: var(--primary-color);">{{ $stats['attendance'] }}%</h2>
                        <div class="d-flex align-items-center gap-2">
                            <span class="badge {{ $stats['attendance'] >= 75 ? 'badge-success-modern' : 'badge-danger-modern' }}">
                                <i class="fas fa-{{ $stats['attendance'] >= 75 ? 'arrow-up' : 'arrow-down' }} me-1"></i> 
                ...
                <div class="col-md-6 col-lg-3 animate-fade-in" style="animation-delay: 0.2s;">
                    <div class="stat-widget-modern lift">
                        ...
                        <h2 class="fw-bold mb-2"
                            style="font-family: 'Bungee', sans-serif; color: var(--success-color);">{{ $stats['pendingAssignments'] }}</h2>
                        <div class="d-flex align-items-center gap-2">
                            <span class="badge {{ $stats['pendingAssignments'] > 0 ? 'badge-warning-modern' : 'badge-success-modern' }}">
                                <i class="fas fa-{{ $stats['pendingAssignments'] > 0 ? 'clock' : 'check' }} me-1"></i> 
                                {{ $stats['pendingAssignments'] > 0 ? 'Action Needed' : 'All Done' }}
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3 animate-fade-in" style="animation-delay: 0.3s;">
                    <div class="stat-widget-modern lift">
                        ...
                        <p class="text-muted mb-1 text-uppercase" style="font-size: 0.75rem; letter-spacing: 0.5px;">
                            Average Grade</p>
                        <h2 class="fw-bold mb-2" style="font-family: 'Bungee', sans-serif; color: #3B82F6;">{{ $stats['averageMarks'] }}</h2>
                        <div class="d-flex align-items-center gap-2">
                            <span class="badge badge-info-modern"><i class="fas fa-graduation-cap me-1"></i> Performance</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3 animate-fade-in" style="animation-delay: 0.4s;">
                    <div class="stat-widget-modern lift">
                        ...
                        <p class="text-muted mb-1 text-uppercase" style="font-size: 0.75rem; letter-spacing: 0.5px;">Fee
                            Status</p>
                        <h2 class="fw-bold mb-2" style="font-family: 'Bungee', sans-serif; color: #F59E0B;">
                            {{ $stats['unpaidFees'] > 0 ? 'Pending' : 'Cleared' }}
                        </h2>
                        <div class="d-flex align-items-center gap-2">
                            <span class="badge {{ $stats['unpaidFees'] > 0 ? 'badge-danger-modern' : 'badge-success-modern' }}">
                                <i class="fas fa-{{ $stats['unpaidFees'] > 0 ? 'exclamation-circle' : 'check-circle' }} me-1"></i>
    ...
    <script>
        ...
        function loadStudentDynamicCharts() {
            ...
            // 4. Result Widget - handled in performance chart below
